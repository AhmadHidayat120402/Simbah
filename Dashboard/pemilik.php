        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <table id="pemilik" class="table table-striped">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
                        ...
                        <tbody>
                            ...
                            include '../connect.php';
                            $no = 1;
                            $pemilik = mysqli_query($koneksi, "SELECT nama_lengkap,username,email,no_telp,password,jk,alamat FROM users WHERE id_status = 2 Order by id_pembeli DESC");
