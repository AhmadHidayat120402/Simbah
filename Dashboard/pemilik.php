...
if (isset($_POST['bsimpan'])) {
    ...
    if ($result) {
        ...
        document.location= 'index.php?halaman=pemilik';
        </script>";
    } else {
        echo "<script>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Form Data Pemilik</h1>
    ...
    <div class="table-responsive">
        <table id="member" class="table table-striped table-bordered w-100 nowrap" width="100%">
            ...
            <tbody>
                ...
                include '../connect.php';
                $no = 1;
                $member = mysqli_query($koneksi, "SELECT id_pembeli,nama_lengkap,username,email,no_telp,password,jk,alamat FROM users WHERE id_status = 2  Order by id_pembeli DESC");
                ...
                ?>
                    ...
                    <div class="modal fade" id="modalHapus<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Konfirmasi Hapus Data Pemilik</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <form action="" method="POST">
                                    <div class="modal-body">
